...
///
/// Includes implementations of `MockKafkaSession`, `MockProducer`,
/// `MockHighLevelConsumer` which conform to corresponding interfaces.
...
export 'package:kafka/kafka.dart';

class MockKafkaSession implements KafkaSession {
  @override
  Future close() {
    return null;
    // no-op
  ...
  @override
  Queue<ContactPoint> get contactPoints {
